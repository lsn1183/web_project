	...
	<div class="g_dialog_shadow" v-show="show">
		<div class="g_dialog g_dialog_ex">
			...
			<h2 class="g_dialog_header">
				<span class="s_section_left">H/U要件定義書から転記</span>
				<!-- 点x关闭弹出框 -->
				<i class="s_section_right s_close el-icon-close" @click="close()"></i>
			</h2>
			<div class="g_dialog_body g_dialog_body_ex">
				<p class="s_section">	
	  	    		<span class="s_left">H/U要件定義ID</span>
					<el-input class="s_right s_textarea" v-model="tagl_def_data_copy.hu_def_id" disabled></el-input>	    	  	    		
	  	    	</p>
				<p class="s_section">	
	  	    		<span class="s_left">大分類</span>
					<el-input class="s_right s_textarea" type="textarea" :rows="2" v-model="tagl_def_data_copy.major_category"></el-input>	    	  	    		
	  	    	</p>	
	  	        <p class="s_section">
	  	    		<span class="s_left">中分類</span>
					<el-input class="s_right s_textarea" type="textarea" :rows="2" v-model="tagl_def_data_copy.medium_category"></el-input>
	  	    	</p>
	  	    	<p class="s_section">
	  	    		<span class="s_left">小分類</span>
					<el-input class="s_right s_textarea" type="textarea" :rows="2" v-model="tagl_def_data_copy.small_category"></el-input>			    	  	    		
	  	    	</p>
	  	    	<p class="s_section">
	  	    		<span class="s_left">詳細</span>
					<el-input class="s_right s_textarea" type="textarea" :rows="2" v-model="tagl_def_data_copy.detail"></el-input>			    	  	    		
	  	    	</p>	
	  	    	<p class="s_section">
	  	    		<span class="s_left">基本要件</span>
					<el-input class="s_right s_textarea" type="textarea" :rows="2" v-model="tagl_def_data_copy.basic_req"></el-input>			    	  	    		
	  	    	</p>
    	  	    <p class="s_section">
	  	    		<span class="s_left">関連基本要件</span>
					<el-input class="s_right s_textarea" type="textarea" :rows="2" v-model="tagl_def_data_copy.rel_requirement"></el-input>			    	  	    		
	  	    	</p>
    	    </div>
