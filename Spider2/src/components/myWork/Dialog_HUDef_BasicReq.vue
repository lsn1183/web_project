	...
	<div class="g_dialog_shadow" v-show="show">
			<div class="g_dialog g_dialog_ex">
				...
				<div class="g_dialog_body">	    	  	    	    	  	    
    	  	    	<!-- TAGL表格 -->
    	  	    	<div class="s_section">		    	     								
						<el-input class="s_textarea" type="textarea" :rows="5" v-model="hu_data_copy.basic_req"></el-input>							    
					</div>		  	    	
	    	    </div>
	...
	export default{
		...
		methods: {
			onshow() {
				...
				this.show = true;
				this.hu_open_data = this.hu_data_copy.basic_req;
				
			},

			close() {
				this.hu_close_data = this.hu_data_copy.basic_req
