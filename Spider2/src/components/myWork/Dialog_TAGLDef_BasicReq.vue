	...
	<div class="g_dialog_shadow" v-show="show">
			<div class="g_dialog g_dialog_ex">
				...
				<h2 class="g_dialog_header">
					<span class="s_section_left">基本要件</span>
					<!-- 点x关闭弹出框 -->
				...
				<div class="g_dialog_body">	    	  	    	    	  	    
    	  	    	<!-- TAGL表格 -->
    	  	    	<div class="s_section">		    	     								
						<el-input class="s_textarea" type="textarea" :rows="5" v-model="tagl_def_data_copy.basic_req"></el-input>							    
					</div>		  	    	
	    	    </div>
	...
	export default{
		...
		methods: {
			onshow() {
				...
				this.show = true;
				this.tagl_def_opened_data = this.tagl_def_data_copy.basic_req;
				
			},

			close() {
				this.tagl_def_closed_data = this.tagl_def_data_copy.basic_req
