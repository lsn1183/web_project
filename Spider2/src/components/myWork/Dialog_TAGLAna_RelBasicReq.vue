	...
	<div class="g_dialog_shadow" v-show="show">
			<div class="g_dialog g_dialog_ex">
				...
				<h2 class="g_dialog_header">
					<span class="s_section_left">関連基本要件</span>
					<!-- 点x关闭弹出框 -->
				...
				<div class="g_dialog_body">	    	  	    	    	  	    
    	  	    	<!-- TAGL表格 -->
    	  	    	<div class="s_section">		    	     								
						<el-input class="s_textarea" type="textarea" :rows="5" v-model="tagl_ana_data_copy.rel_requirement"></el-input>							    
					</div>		  	    	
	    	    </div>
	...
	export default{
		...
		methods: {
			onshow() {
				...
				this.show = true;
				this.tagl_ana_opened_data = this.tagl_ana_data_copy.rel_requirement;
				
			},

			close() {
				this.tagl_ana_closed_data = this.tagl_ana_data_copy.rel_requirement
