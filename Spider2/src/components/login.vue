	...
	<div id="login">
		<div class="content">
			<section class="section">
				<div><img src="../assets/img/Icon/Spider_Icon.png" alt="Spider Logo" /></div>
				<p>欢 迎 来 到 文 档 管 理 网 站</p>
			</section>
		</div>
		<header>
			<div class="fl"><img src="../assets/img/Text/Spider_Text.png" /></div>
		...
		<div id="popup" v-if="popup_flag == true">
			...
			<div class="login_content" v-if="Login_flag">
				<!--<div class="login_fl">
                <img src="../assets/img/Icon/Spider_Icon.png" alt="" class="logo">
                <h2 class="size">Welcome to SPIDER</h2>
            </div>-->
				<div class="login_fr">
					<div class="big_re">
						<p class="Regist fl" @click="ToLogin" style="border-bottom: 2px solid #42b983;">登录</p>
						<!--<p class="Regist fr" @click="ToRegist" style="color: #999;">注册</p>-->
                ...
                <p class="hint_size">用户名或密码错误</p>
                <p class="hint_size">请再次输入</p>
                <button class="hitn_btn" @click="al">确定</button>
            </div>-->
			</div>
			<!-- 注册页面 -->
			<div class="login_content" v-if="Regist_flag">
				...
				<div class="login_fr">
					<div class="big_re">
						...
						<!--<p class="Regist fr" @click="ToRegist" style="border-bottom: 2px solid #42b983;">注册</p>-->
					</div>
					<div @keyup.enter="SUB()">
						<p class="value_content">
						...
						<p class="value_content">
							...
							<!--<ul class="login_key" v-show="pwd_flag == true">
											    <li :class=" correct_flag ?'correct':'error'">长度为6-15个字符</li>-->
							<!--<li :class=" correct_flag ?'correct':'error'">支持数字、大小写字母和标点符号</li>
											    <li :class=" correct_flag ?'correct':'error'">不允许有空格</li>-->
							<!--</ul>-->
