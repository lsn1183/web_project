			...
			a.jstree = {
				...
				init: function(b, c) {
					this._model = {
						...
						this.settings = c, this._data.core.ready = !1,
					...
					this.element.attr("tabindex") || this.element.attr("tabindex", "0"), this.bind(),
						this.trigger("init"),
						...
						this._data.core.node = this._create_prototype_node(), this.trigger("loading"),
