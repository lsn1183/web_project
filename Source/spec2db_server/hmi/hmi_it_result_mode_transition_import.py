# -*- coding: UTF-8 -*-
from Source.spec2db_server.hmi.hmi_it_result_mode_transition import HimItResultModeTransition
from Source.spec2db_server.docs.doc_xls import DocXls
from Source.spec2db_server.hmi.hmi_log import HmiLog


class HimItResultModeTransitionImport(HimItResultModeTransition):
    def __init__(self):
        HimItResultModeTransition.__init__(self)

    def do_import(self, pg, file_name, xls_file_name, commit_user_id, update_time):
        result = {"result": "NG", "error": ''}
        try:
            xls_list = DocXls('HMI_IT_RESULT_MODE_TRANSITION', '0.01').load_data(xls_file_name)
...
if __name__ == '__main__':
    ...
    HimItResultModeTransitionImport().do_import(r'/mnt/sharedoc/Him_ItResultModeTransitionImport_v001.xlsx', 341,
