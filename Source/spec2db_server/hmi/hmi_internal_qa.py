...
class HmiInternalQA(HMIBase):
    def __init__(self):
        ...
        self.id_col = 'qa_no'
        self.attr_list = [
            'qa_rc_id', 'qa_no', 'status', 'question', 'qa_date',
            'qa_author', 'hope_answer_date', 'answer_detail',
            'answer_date', 'answerer']
