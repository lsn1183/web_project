...
public class XlsHuPointV3 extends XlsPointBase{
    ...
    public XlsHuPointV3(){
        ...
        this.suntecStatus.xIndex = 8;
        this.suntecStatus.yIndex = 89;
