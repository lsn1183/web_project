...
public class XlsAnaPointV2 extends XlsPointBase{
    public int titleRowIndex = 4;
    public int startRow = 5;

    public XlsAnaPointV2(){
        this.version="v2";
        ...
        this.arlCannotModify.yIndex = 145;
