...
public class XlsDefPointV2 extends XlsPointBase{
    public int titleRowIndex = 4;
    public int startRow = 5;

    public XlsDefPointV2(){
        this.version="v2";
