...
public class XlsDefPointV6 extends XlsPointBase{
    public int titleRowIndex = 4;
    public int startRow = 5;

    public XlsDefPointV6(){
        this.version="v6";
        ...
        this.arlCannotModify.yIndex = 76;
