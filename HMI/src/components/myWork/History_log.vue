							...
							for(var i = 0; i < this.loglist.length; i++) {
								switch(this.loglist[i].classify) {
									...
									case 'definition':
										...
										break;
									case 'basic_req_hu':
										var basic_HU = "HU基本要件定義" + this.loglist[i].id
										this.loglist[i].title = basic_HU
										break;
									case 'basic_req_definition':
										var basic_DEF = "TAGL基本要件定義" + this.loglist[i].id
										this.loglist[i].title = basic_DEF
										break;
									case 'basic_req_analysis':
										var basic_ANA = "TAGL基本要件分析" + this.loglist[i].id
										this.loglist[i].title = basic_ANA
										break;
									default:
