<template>
	<div id='USERs'>
		...
		<div class="left_menu left_menu_ex fl">
			<div>
				<ul>
					<li :class="{'active': hl==1}"  @click='VIP()' >IT进度报告开发状态</li>
				</ul>
			</div>
		</div>
		<!-- 右边内容 -->				
		<div class="right">
			<div class="sumbit_table sumbit_tabke_ex">
		 	...
		 	<div class="table table_ex" v-show="G_flag == true">
		 		<!-- 新增开发状态 -->
		 		<h3 style="padding-left: 60px;padding-bottom: 10px;">IT进度报告开发状态</h3>
		 		<el-form :model="dynamicValidateForm[0]" ref="dynamicValidateForm" label-width="80px" class="demo-dynamic">
		 			<div style="overflow-y: scroll;max-height: 500px;margin-bottom: 5px;">
		 				...
		 				<el-form-item
			 				...
			 				>
			 				<el-input v-model="dynamicValidateForm[0].status" placeholder="请选择开发状态分类"></el-input>
			 			</el-form-item>
			 			<!-- <el-form-item
...
//							}
				...
				let data_json = {classify:"it_dev",status_list:Array_req_dev_status}
			...
			get_HmiDevStatus(){
				this.$axios.get(this.Ip + '/HmiDevStatus/it_dev')
				.then(res => {
					console.log(res)
			...
			submitForm(formName){
				this.$refs[formName].validate( (res) => {
					if(res){
						...
						let data_json = {classify:"it_dev",status_list:Array_add_dev_state} 
