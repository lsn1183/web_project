...
Revision ID: 03bbf8dd0015
Revises: 1d11e570d127
Create Date: 2019-04-25 10:36:50.397200
...
revision = '03bbf8dd0015'
down_revision = '1d11e570d127'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(None, 'conditions', ['condition'], schema='public')
    ...
    op.create_unique_constraint(None, 'displays', ['display'], schema='public')
    ...
    op.create_unique_constraint(None, 'events', ['event'], schema='public')
    ...
    op.create_unique_constraint(None, 'ope_types', ['ope_type'], schema='public')
    ...
    op.create_unique_constraint(None, 'properties', ['property_type'], schema='public')
...
def downgrade():
    ...
    op.drop_constraint(None, 'properties', schema='public', type_='unique')
    ...
    op.drop_constraint(None, 'ope_types', schema='public', type_='unique')
    ...
    op.drop_constraint(None, 'events', schema='public', type_='unique')
    ...
    op.drop_constraint(None, 'displays', schema='public', type_='unique')
    ...
    op.drop_constraint(None, 'conditions', schema='public', type_='unique')
