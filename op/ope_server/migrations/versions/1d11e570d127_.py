...
Revision ID: 1d11e570d127
Revises: f7cdc7ba87cc
Create Date: 2019-04-24 16:03:22.565800
...
revision = '1d11e570d127'
down_revision = 'f7cdc7ba87cc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('file_seq',
    sa.Column('file_seq_id', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('file_seq_id'),
    schema='public'
    )
...
def downgrade():
    ...
    op.drop_table('file_seq', schema='public')
    # ### end Alembic commands ###
