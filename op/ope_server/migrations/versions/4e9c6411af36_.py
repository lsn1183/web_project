...
Revision ID: 4e9c6411af36
Revises: e802edb1ab2a
Create Date: 2019-04-23 20:02:54.836400
...
revision = '4e9c6411af36'
down_revision = 'e802edb1ab2a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_column('chapter8', 'trig_name')
...
def downgrade():
    ...
    op.add_column('chapter8', sa.Column('trig_name', sa.VARCHAR(length=256), autoincrement=False, nullable=True))
