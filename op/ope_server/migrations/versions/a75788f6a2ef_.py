...
Revision ID: a75788f6a2ef
Revises: 4e9c6411af36
Create Date: 2019-04-24 14:49:24.550600
...
revision = 'a75788f6a2ef'
down_revision = '4e9c6411af36'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('screen', sa.Column('update_user', sa.Integer(), nullable=True))
    op.create_index(op.f('ix_public_screen_update_user'), 'screen', ['update_user'], unique=False, schema='public')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_public_screen_update_user'), table_name='screen', schema='public')
    op.drop_column('screen', 'update_user')
