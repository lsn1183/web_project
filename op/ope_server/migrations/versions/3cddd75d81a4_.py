...
Revision ID: 3cddd75d81a4
Revises: 03bbf8dd0015
Create Date: 2019-04-25 19:34:30.445800
...
revision = '3cddd75d81a4'
down_revision = '03bbf8dd0015'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index('conditions_proj_id_condition', 'conditions', ['proj_id', 'condition'], unique=True, schema='public')
    op.drop_constraint('conditions_condition_key', 'conditions', type_='unique')
    ...
    op.create_index('displays_proj_id_display', 'displays', ['proj_id', 'display'], unique=True, schema='public')
    ...
    op.create_index('events_proj_id_event', 'events', ['proj_id', 'event'], unique=True, schema='public')
    ...
    op.create_index('ope_types_proj_id_ope_type', 'ope_types', ['proj_id', 'ope_type'], unique=True, schema='public')
    ...
    op.create_index('properties_proj_id_property_type', 'properties', ['proj_id', 'property_type'], unique=True, schema='public')
...
def downgrade():
    ...
    op.drop_index('properties_proj_id_property_type', table_name='properties', schema='public')
    ...
    op.drop_index('ope_types_proj_id_ope_type', table_name='ope_types', schema='public')
    ...
    op.drop_index('events_proj_id_event', table_name='events', schema='public')
    ...
    op.drop_index('displays_proj_id_display', table_name='displays', schema='public')
    ...
    op.create_unique_constraint('conditions_condition_key', 'conditions', ['condition'])
    op.drop_index('conditions_proj_id_condition', table_name='conditions', schema='public')
