...
Revision ID: 5f3eb0b663e6
Revises: 31fff8111f3a
Create Date: 2019-04-26 18:27:08.848233
...
revision = '5f3eb0b663e6'
down_revision = '31fff8111f3a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_index('ix_public_screen_locked', table_name='screen')
    ...
    op.drop_column('screen', 'locked')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('screen', sa.Column('locked', sa.VARCHAR(length=10), autoincrement=False, nullable=True))
    ...
    op.create_index('ix_public_screen_locked', 'screen', ['locked'], unique=False)
