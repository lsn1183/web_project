...
Revision ID: 7a340279fda5
Revises: 5f3eb0b663e6
Create Date: 2019-04-26 18:27:29.704426
...
revision = '7a340279fda5'
down_revision = '5f3eb0b663e6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('screen', sa.Column('locked', sa.Boolean(), nullable=True))
