            ...
            <div class="mid">
                <div class="mid-top">
                    ...
                    <div class="div-center div-center-label">
                        <div class="div-title">基本设计:</div>
                        <div class="div-input">
                            <!-- <el-input v-model="file_form.title"></el-input> -->
                            <el-select v-model="basic_model" placeholder="请选择" :disabled="select_option_flag">
                                <!-- <el-option
                                    v-for="item in basic_options"
                                    :key="item.doc_id"
                                    :label="item.title"
                    ...
                    <div class="div-center div-center-label">
                        ...
                        <div class="div-input">
                            <!-- <el-input v-model="file_form.title"></el-input> -->
                            <el-checkbox v-model="checked_copy" label="拷贝已选择的基本设计" :disabled="checked_basic_flag"></el-checkbox>
                        </div>
                    </div>
                    <div class="div-center div-center-label">
...
export default {
    ...
    methods: {
        reqSummary () {
            ...
            this.$axios.get(this.Ip + '/DSDoc/' + window.sessionStorage.getItem('DocId')).then(res => {
                if (res.data.result == 'OK') {
                    this.file_form = res.data.content
                    if (res.data.content.parent_doc == null) {
                        this.basic_model = ""
                    } else {
                       this.basic_model = this.file_form.parent_doc.title 
                    }
                    if (res.data.content.copy_on == true) {
                        this.checked_copy = true
                    } else {
