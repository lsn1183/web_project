...
export default {
    ...
    methods: {
        ...
        realFunc() {
            ...
            // let domIndex = -1
            // for (let i = 0; i < len; i++) {
            //     // distanceOfTop为DOM元素距离顶部（滚动条顶部）的长度
            //     let distanceOfTop = $('.msg-box').eq(i).offset().top - nav_height
            //     if (i == 0 && $('.msg-box').eq(i).offset().top - nav_height - 1 > 0) {
            //         console.log(i)
            //         console.log($('.msg-box').eq(i).offset().top - nav_height, 'height')
            
            //         console.log(domIndex, 'domIndex1111')
            //         domIndex = 0
            //         break
            //     }
            //     if ($('.msg-box').eq(i).offset().top - nav_height == 0) {
            //         domIndex = i
            //         break
            //     }
            ...
            // console.log(domIndex, 'domIndex2222')
            // if (domIndex == 0) {
            //     $('.first-title').css({ color: '#606266' })
            //     $('.second-title').css({ color: '#606266' })
            //     $('.first-title').eq(0).css({ color: '#42b983' })
            //     return
            // }
            // if (domIndex > -1) {
            //     $('.first-title').css({ color: '#606266' })
            //     $('.second-title').css({ color: '#606266' })
            //     $('.second-title').eq(domIndex).css({ color: '#42b983' })
            //     return
            // }
            // if (domIndex == -1) {
            //     $('.first-title').css({ color: '#606266' })
            //     $('.second-title').css({ color: '#606266' })
            //     $('.first-title').eq(domIndex).css({ color: '#42b983' })
            //     return
            // }
            ...
            // $('.first-title').css({ color: '#606266' })
            // $('.second-title').css({ color: '#606266' })
            // $('.second-title').eq(len - 1).css({ color: '#42b983' })
        },
        scrollHandler() {
            let timeout
